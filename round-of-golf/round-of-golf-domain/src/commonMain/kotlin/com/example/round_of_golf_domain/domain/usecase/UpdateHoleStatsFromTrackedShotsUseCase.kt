...
class UpdateHoleStatsFromTrackedShotsUseCase(
    private val getTrackedShotsForHoleUseCase: GetTrackedShotsForHoleUseCase,
    ...
    suspend operator fun invoke(
        ...
        return try {
            val trackedShots = getTrackedShotsForHoleUseCase.getShotsForHoleSuspend(scoreCard.roundId, holeNumber)
